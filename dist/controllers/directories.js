import { createDirectory, getDirectories, getDirectoryById, deleteDirectoryById } from '../db/directories.js';
import { getUserBySessionToken } from '../db/users.js';
import { PineUpload } from '../scripts/pinecone.js';
import { createFulfilledGuideline, getFulfilledGuidelineByGuidelineAndDirectory } from '../db/directories.js';
export const noteCorrectPassage = async (req, res) => {
...
export const getCorrectPassage = async (req, res) => {
    try {
...
export const makeDirectory = async (req, res) => {
    try {
