import { createGuidelineSet, getGuidelineSets, deleteGuidelineSetById, deleteGuidelineById, getGuidelineById, createGuideline, getGuidelineSetById, updateGuidelineSet, updateGuideline } from '../db/guidelines.js';
...
export const getGuidelineSet = async (req, res) => {
    try {
...
export const deleteGuidelineSet = async (req, res) => {
...
export const updateGuidelineSetById = async (req, res) => {
    try {
...
export const guidelinesBySetId = async (req, res) => {
    const { id } = req.body;
...
export const addGuidelineToSet = async (req, res) => {
...
export const getGuidelinesByGuidelineSet = async (req, res) => {
    try {
...
export const getCurrentGLSet = async (req, res) => {
    try {
        const sessionToken = req.cookies['USER-AUTH'];
        const user = await getUserBySessionToken(sessionToken);
        if (!user) {
...
export const GetFulfilledGuideline = async (req, res) => {
    try {
...
export const MakeOrUpdateFulfilledGuideline = async (req, res) => {
    try {
