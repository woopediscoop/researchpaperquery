...
export const createCheckingPrompt = (values) => new CheckingPromptModel(values).save().then((checkingPrompt) => checkingPrompt.toObject());
export const getCheckingPromptByVectorQuery = (vectorquery_id) => CheckingPromptModel.findOne({ VectorResult: vectorquery_id });
...
export const deleteCheckingPromptById = (id) => CheckingPromptModel.findOneAndDelete({ _id: id });
