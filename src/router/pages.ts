...
import { renderLoginPage, renderNamespaceManager, renderHomePage, 
    renderPdfUpload, renderVectorSearch, renderPromptSearch,
    renderGuidelinePage, renderCreateGLSet, renderCreateGLPage,
    renderDirectoryPage, renderCreateDir,
    renderVectorQuery, renderQueryResult, renderFilterQueries,
    renderEditGuideline } from '../controllers/pages.js';
