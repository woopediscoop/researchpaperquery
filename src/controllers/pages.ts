...
export const renderEditGuideline = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/editguideline.html'));
}
export const renderFilterQueries = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/filterqueries.html'));
}
export const renderVectorQuery = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/vectorquery.html'));
}

export const renderQueryResult = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/vecqueryresult.html'));
}

export const renderCreateDir = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/createdirectory.html'));
}

export const renderDirectoryPage = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/directorylanding.html'));
}

export const renderCreateGLPage= async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/addgl.html'));
}

export const renderGuidelinePage = async (req: express.Request, res: express.Response) => {
    return res.sendFile(path.join(__dirname,'../public/chooseglset.html'));
}

export const renderCreateGLSet = async (req: express.Request, res: express.Response) => {
