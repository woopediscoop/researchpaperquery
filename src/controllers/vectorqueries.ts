...
import {createVectorQuery, getVectorQueriesByGuideline, getVectorQueriesByGuidelineAndUser, getVectorQueriesByUserAndGuidelineSet, 
    updateVectorQueryById, deleteVectorQueryById, getVectorQueryById, queryVectorQueries} from '../db/vectorqueries.js';
...
export const evaluateQuery = async (req: express.Request, res: express.Response) => {
    try{
...
export const findQueries = async (req: express.Request, res: express.Response) => {
    try{
...
export const getVectoryQuery = async (req: express.Request, res: express.Response) => {
    try{
...
export const makeVectorQuery = async (req: express.Request, res: express.Response) => {
    try{
...
export const deleteQuery = async (req: express.Request, res: express.Response) => {
    try{
        const sessionToken = req.cookies['USER-AUTH'];
        const user = await getUserBySessionToken(sessionToken);
...
export const getQueriesByGuideline = async (req: express.Request, res: express.Response) => {
    try{
