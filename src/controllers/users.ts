...
export const updateUserCurrentGLSet = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
    ...
    const updatedUser = await updateUserById(user.id, {
      CurrentGuidelineSet: currentgl_id,
    });
...
export const postNamespaceBySessionToken = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
    ...
    if (allNamespaces.includes(newNamespace)) {
      ...
      return res.json({ message: "Namespace already exists!", success: false });
    }
...
export const vectorQuery = async (
  ...
  return res.json(
    await QueryPine(req.body.name, req.body.namespace, req.body.query),
  );
};

export const promptQuery = async (
  req: express.Request,
  res: express.Response,
) => {
...
export const selectNamespaceBySessionToken = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
...
export const getNamespacesBySessionToken = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
...
export const getCurrentNamespaceBySessionToken = async (
  req: express.Request,
  res: express.Response,
) => {
  try {
